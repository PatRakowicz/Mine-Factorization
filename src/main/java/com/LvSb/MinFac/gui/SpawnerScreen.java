package com.LvSb.MinFac.gui;

import com.LvSb.MinFac.Main;
import com.LvSb.MinFac.network.Networking;
import com.LvSb.MinFac.network.PacketSpawn;
...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(Main.MODID, "textures/gui/spawner_gui.png");
