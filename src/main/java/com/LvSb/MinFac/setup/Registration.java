...
import com.LvSb.MinFac.blocks.*;
import com.LvSb.MinFac.items.FirstItem;
import com.LvSb.MinFac.items.WeirdMobEggItem;
import com.mcjty.mytutorial.blocks.*;
import com.LvSb.MinFac.dimension.TutorialModDimension;
import com.LvSb.MinFac.entities.WeirdMobEntity;
...
public class Registration {
    ...
    private static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITIES, Main.MODID);
    private static final DeferredRegister<ModDimension> DIMENSIONS = DeferredRegister.create(ForgeRegistries.MOD_DIMENSIONS, Main.MODID);
