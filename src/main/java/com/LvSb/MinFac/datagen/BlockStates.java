...
import com.LvSb.MinFac.blocks.ComplexMultipartBlock;
import com.LvSb.MinFac.blocks.ComplexMultipartTile;
...
public class BlockStates extends BlockStateProvider {
    ...
    private void registerFirstBlock() {
        ResourceLocation txt = new ResourceLocation(Main.MODID, "block/firstblock");
        BlockModelBuilder modelFirstblock = models().cube("firstblock", txt, txt, new ResourceLocation(Main.MODID, "block/firstblock_front"), txt, txt, txt);
        BlockModelBuilder modelFirstblockPowered = models().cube("firstblock_powered", txt, txt, new ResourceLocation(Main.MODID, "block/firstblock_powered"), txt, txt, txt);
